 ...
 * @category Gc
 * @package  Config
 * @author   Konstantin Erohin (Ekwator) <ekwatormail@gmail.com>
...
return array (
    ...
    'Available children' => 'Доступные подчинения',
    'Content' => 'Содержание',
    'Cookie domain' => 'Печение домена',
    'Cookie path' => 'Путь печенья',
    'Copy' => 'Копировать',
    'Create' => 'Создать',
    'Create document' => 'Создать документ',
    'Create, edit, and delete users.' => 'Создание, редактирование и удаление пользователей.',
    'Create, edit, and delete views.' => 'Создание, редактирование и удаление видов.',
    'Create your own website' => 'Содание собственного сайта.',
    'Cut' => 'Вырезать',
    'Dashboard' => 'Панель настроек',
    'Data can be stored in. Create your own datatype, edit configuration and insert it in document type.' => 'Можно сохранять любые данные. Создайте свой тип данных, Зайдите в конфигурирование, и выберете этот тип для своего документа.',
    'Datatype' => 'Тип данных',
    'Datatypes' => 'Типы данных',
    'Debug' => 'Отладка',
    'Debug is active' => 'Отладка активирована',
    'Cache' => 'Кеш',
    'Cache is active' => 'Кеш активерован',
    'Cache handler' => 'Обработчик кеша',
    'Cache lifetime' => 'Время жизни кеша',
    'Web' => 'Сеть',
    'Force backend SSL' => 'Принудительный SSL для сервера',
    'Force frontend SSL' => 'Принудительный SSL для интерфейса',
    'Unsecure backend base path' => 'Обычный путь сервера',
    'Unsecure frontend base path' => 'Обычный путь интерфейса',
    'Secure backend base path' => 'Безопасный путь сервера',
    'Secure frontend base path' => 'Безопасный путь интерфейса',
    'Unsecure cdn base path' => 'Обычный путь функций cdn',
    'Secure cdn base path' => 'Безопасный путь функций cdn',
    'Default view' => 'Вид по умолчанию',
    'Define the data to be used for the website such as the locale, sessions, name...' => 'Определите данные, которые будут использоваться для сайта, такие как язык, сессии, имя ...',
    'Delete' => 'Удалить',
    'Development' => 'Разработка',
    'Developper' => 'Разработчик',
    'Disconnect' => 'Разъеденить',
    'Document types' => 'Тип документа',
    'Edit' => 'Редактировать',
    'Edit translation for frontend and backend.' => 'Редактировать перевод содержания для интерфейса и сервера".',
    'elFinder is an open-source file manager for web. And with you can manage your files, folders and others data of this website.' => 'elFinder является открытым исходным кодом файлового менеджера для сайта. С его помощью вы можете управлять своими файлами, папками и другими данными этого сайта.',
    'Fast links' => 'Быстрая ссылка',
    'File manager' => 'Файловый менеджер',
    'Files' => 'Файлы',
    'Firstname' => 'Имя',
    'Forgot your password?' => 'Забыли пароль?',
    'From E-mail' => 'E-mail от',
    'From name' => 'Имя отправителя',
    'General' => 'Главная',
    'General configuration' => 'Главная конфигурация',
    'He has many options like an window explorer. Be careful when deleting data, it is not reversible.' => 'Есть много опций как у окна проводника. Будьте внимательны при удалении данных, операция не обратима!',
    'Identifier' => 'Идентификатор',
    'Import tab' => 'Импорт вкладок',
    'Insert in document types, if you want to get and use property write: $this->propertyIdentifier' => 'Вставте тип объекта в документ, если вы хотите получить и использовать сведения об объекте : $this->propertyIdentifier',
    'Is active' => 'Активировано',
    'Is offline' => 'Автономный режим',
    'Lastname' => 'Фамилия',
    'Layouts' => 'Шаблон',
    'Limit users access with roles and permissions' => 'Ограничения пользователей  для ролей',
    'List' => 'Список',
    'list' => 'список',
    'Log In' => 'Вход',
    'Make the M.V.C be with you' => 'M.V.C создано для тебя',
    'Manage content' => ' ',
    'Manage documents' => ' ',
    'Manage modules' => ' ',
    'Managing configuration' => 'Управление конфигурацией',
    'Managing Datatypes' => 'Управление типами данных',
    'Managing documents' => 'Управление документами',
    'Managing Document types' => 'Управление типами документов',
    'Managing Layouts' => 'Управление шаблонами',
    'Managing resources' => 'Управление ресурсами',
    'Managing Roles' => 'Управление ролями',
    'Managing Scripts' => 'Управление скриптами',
    'Managing translation' => 'Управление переводом',
    'Managing Users' => 'Управление пользователями',
    'Managing Views' => 'Управление видами',
    'Model' => 'Модель',
    'Name' => 'Имя',
    'New' => 'Новый',
    'Next' => 'Следующий',
    'Offline document' => 'Документ снят с публикации',
    'Online documents' => 'Документ опубликован',
    'Driver' => 'Драйвер',
    'Hostname' => 'Сервер базы данных',
    'Db Name' => 'База данных',
    'Configure your website' => 'Конфигурация Вашего сайта',
    'Roles' => 'Роли',
    'Select document' => 'Выберите документ',
    'Username' => 'Пользователь',
    'Password' => 'Пароль',
    'Login' => 'Пользователь администратор',
    'Admin password' => 'Пароль администратора',
    'Confirm admin password' => 'Подтверждение пароля администратора',
    'Default template' => 'Основной шаблон',
    ...
    'Insert data' => 'Заполнение базы данных',
    ...
    'Server' => 'Сервер',
    'Server locale' => 'Язык сервера',
    'Session' => 'Сессия',
    'Session path' => 'Путь сохранения сессий',
    'Session handler' => 'Обработчик сессии',
    'Session lifetime' => 'Время жизни сесии',
    'Site name' => 'Имя сайта',
    'Staffer' => 'Сотрудник',
    'System' => 'Система',
    'System configuration' => ' ',
    'Tabs' => 'Вкладки',
    'There\'s lot of Helper you can use. Those Zend Framework and GotCms, refer to documentation if you want more information.' => 'За дополнительной информацией обратитесь к документации, если вы хотите получить больше информации о Zend Framework и GotCms.',
    'These items will be permanently deleted and cannot be recovered. Are you sure?' => 'Эти элементы будут удалены и не могут быть восстановлены. Вы уверены, ?',
    'This is a document pattern. Sort by tabs, insert datatypes and specify availables views.' => 'Это шаблон документа . Сортировка по вкладкам, типам данных и видам.',
    'Total documents' => 'Документов всего',
    ...
    'Work like views, you can get properties, use helpers, and if you want to integrate children (view) write: $this->content.' => 'Для использования вида Вы должны определить свойства, используйте помошника вида для внедрения подчиненых видов: $this->content.',
    'Work like Zend Framework controllers, you can get the request, response and controller plugins.' => 'Работает как контроллеры Zend Framework, имеется доступ к запросу, ответу и плагинам контроллера.',
    'You can create, edit, copy, cut and paste document by right-clicking on Website or children documents.' => 'Вы можете создавать, редактировать, копировать, вырезать и вставлять документ щелкнув правой кнопкой мыши на веб-сайте или подчененном документе.',
    'You use GotCms %s' => 'Вы используете GotCms %s',
    'Steps:' => 'Шаг :',
    'Installation' => 'Установка',
    'Please select language' => 'Выберите язык',
    'Language' => 'Язык',
    'License' => 'Лицензия',
    'Pre-configuration' => 'Установка конфигурации',
    'Database' => 'База данных',
    'You must accept this license for continue to install this software.' => 'Вы должны принять условия лицензии для продолжения установки этого программного обеспечения.',
    'Continue' => 'Продолжить',
    ...
    '%s is writable' => '%s разрешено на запись',
    'Recommended settings:' => 'Рекомендуемые параметры',
    'These settings are recommended for PHP in order to ensure full compatibility.' => "Для обеспечени полной совместимости, эти настройки рекомендуется для PHP.",
    'Actual' => 'Определено',
    'All parameters must be set to "Yes"' => 'Все параметры должны быть установлены на значение \"Да\"',
    'Stats' => 'Статус',
    'Total visitors' => 'Посетителей всего',
    'Total page views' => 'Просмотров страниц всего',
    'Update' => 'Обновление',
    'all' => 'все',
    'user' => 'пользователь',
    'system' => 'система',
    ...
    'You already have the latest version' => 'Установлена последняя версия',
    'This day' => "Текущий день",
    'This month' => 'Месяц',
    'This year' => 'Год',
    'All the time' => 'Все время',
    'Pages views' => 'Просмотр страницы',
    'Visitors' => 'Посетитель',
    'Most urls views' => 'Адреса, набольшие просмотры ',
    'Referers' => 'Ссылки',
    'These modules may have problems:' => 'Этот модуль имеет проблемы :',
    'These datatypes may have problems:' => 'Этот тип данных имеет проблемы :',
    'Version %s has been released, please upgrade for security issues.' => 'Существует новая версия %s , пожалуста обновите для обеспечения безопасности.',
    'Do you really want to update GotCms?' => 'Вы действительно хотите обновить GotCms ?',
    'You can follow this project on github:' => 'Ссылка проекта на  github :',
    'Admin panel' =>  "Панель управления",
    'Modules' => 'Модули',
    'Module' => 'Модуль',
    'Select an option' => 'Выберите ...',
    ...
    'uninstall' => 'деинсталяция',
    '-- Select --' => '-- Выбор --',
    'Show / Hide form create datatype' => 'Показать / Скрыть типы данных',
    'Tab' => 'Вкладка',
    'Download all files' => 'Загрузить все файлы',
    'Upload file' => 'Загрузка файла',
    'Files as: identifier.phtml' => 'Формат файла : .phtml',
    'Upload' => 'Загрузка',
    'Download file' => 'Загрузка файла',
    '%d active comment(s)' => '%d включить комментарии',
    '%d unactive comment(s)' => '%d отключить комментарии',
    'Generate' => 'Генерировать',
    'Data only' => 'Только даные',
    'Structure only' => 'Только структура',
    'Structure and data' => 'Структура и данные',
    'Download' => 'Загрузка',
    'Care' => 'Внимание',
    'Logout' => 'Выход',
    'Click to logout' => 'Нажмите для выхода',
    'This script has been saved' => 'Скрипт сохранен',
    'This layout has been saved' => 'Шаблон сохранен',
    'This view has been saved' => 'Вид сохранен',
    'This user has been saved' => 'Пользователь сохранен',
    'This datatype has been saved' => 'Тип данных сохранен',
    'This document type has been saved' => 'Тип документа сохранен',
    'Configuration saved' => 'Конфигурация сохранена',
    'User can not be saved' => 'Не возможно сохранить пользователя',
    'User does not exists' => 'Пользователь не определен',
    'The user has been deleted' => 'Пользователь удален',
    'This datatype has been deleted' => 'Тип данных удален',
    'This document type has been deleted' => 'Тип документа удален',
    'This tab has been deleted' => 'Вкладка удалена',
    'This property has been deleted' => 'Свойство удалено',
    'This layout has been deleted' => 'Шаблон удален',
    'This script has been deleted' => 'Скрипт удален ',
    'This view has been deleted' => 'Вид удален',
    'Role has been deleted' => 'Роль удалена',
    'Role does not exists' => 'Роль не опрелена',
    'Datatype does not exists' => 'Тип данных не определен',
    'Document type does not exists' => 'Тип документа не определен',
    'View does not exists' => 'Вид не определен',
    'Layout does not exists' => 'Шаблон не определен',
    'Script does not exists' => 'Скрипт не определен',
    'Git project has been found, make sure you clone with apache user.' => 'Проект git найден, проверте настройки пользователя сервера apache.',
    ...
    // Zend\Validator\Csrf
    "The form submitted did not originate from the expected site" => "Форма подтверждения не пренадлежит ожидаемому сайту",
    ...
    "The input does not appear to be a valid date" => "Ввод содержит неверное значение даты",
    ...
    "The input is not a valid step" => "Неверное значение периода",
    ...
    //"Invalid type given. String expected" => "Неверный тип, ожидается строка",
    "The input is not a valid email address. Use the basic format local-part@hostname" => "Неверное значение адреса email. Используйте формат: local-part@hostname",
    "'%hostname%' is not a valid hostname for the email address" => "Неверное значение хоста '%hostname%' для адреса email",
    "'%hostname%' does not appear to have any valid MX or A records for the email address" => "'%hostname%' - Неверное значение MX или записи A для адреса email",
    "'%hostname%' is not in a routable network segment. The email address should not be resolved from public network" => "'%hostname%' - Адрес не найден в маршрутах сегмента сети. Невозможно определить email адрес в сети публичного доступа.",
    ...
    "File '%value%' has a false extension" => "Файл '%value%' имеет неверное расширение",
    //"File '%value%' is not readable or does not exist" => "Файл '%value%' недоступен для чтения или не существует",
