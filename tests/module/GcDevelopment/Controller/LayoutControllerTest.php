...
class LayoutControllerTest extends AbstractHttpControllerTestCase
{
     ...
     * @return void
     */
    public function testUpdateActionWithInvalidId()
    {
        $this->dispatch('/admin/development/layout/update/9999');
        $this->assertResponseStatusCode(302);

        $this->assertModuleName('GcDevelopment');
        $this->assertControllerName('LayoutController');
        $this->assertControllerClass('LayoutController');
        $this->assertMatchedRouteName('development/layout/update');
    }
     ...
     * @return void
     */
    public function testUpdateActionWithId()
    {
        $layoutModel = LayoutModel::fromArray(
            array(
                'name' => 'LayoutName',
        ...
        $this->dispatch('/admin/development/layout/update/' . $layoutModel->getId());
        $this->assertResponseStatusCode(302);
    ...
    public function testUpdateAction()
    {
        ...
        $this->dispatch('/admin/development/layout/update');
        $this->assertResponseStatusCode(302);
