...
class ViewControllerTest extends AbstractHttpControllerTestCase
{
    ...
    {
        $this->dispatch('/admin/development/view/update/9999');
        $this->assertResponseStatusCode(302);

        $this->assertModuleName('GcDevelopment');
        $this->assertControllerName('ViewController');
        $this->assertControllerClass('ViewController');
        $this->assertMatchedRouteName('development/view/update');
    }
    ...
    public function testUpdateActionWithId()
    {
        ...
        $this->dispatch('/admin/development/view/update/' . $viewModel->getId());
        $this->assertResponseStatusCode(302);
    ...
    public function testUpdateAction()
    {
        ...
        $this->dispatch('/admin/development/view/update');
        $this->assertResponseStatusCode(302);
