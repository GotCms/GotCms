...
class ScriptControllerTest extends AbstractHttpControllerTestCase
{
    ...
    {
        $this->dispatch('/admin/development/script/update/9999');
        $this->assertResponseStatusCode(302);

        $this->assertModuleName('GcDevelopment');
        $this->assertControllerName('ScriptController');
        $this->assertControllerClass('ScriptController');
        $this->assertMatchedRouteName('development/script/update');
    }
    ...
    public function testUpdateActionWithId()
    {
        ...
        $this->dispatch('/admin/development/script/update/' . $scriptModel->getId());
        $this->assertResponseStatusCode(302);
    ...
    public function testUpdateAction()
    {
        ...
        $this->dispatch('/admin/development/script/update');
        $this->assertResponseStatusCode(302);
