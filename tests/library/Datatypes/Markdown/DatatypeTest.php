...
class DatatypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('Datatypes\Markdown\Editor', $this->object->getEditor($this->property));
    }
    ...
    {
        $this->assertInstanceOf('Datatypes\Markdown\PrevalueEditor', $this->object->getPrevalueEditor());
    }
}
