...
class DatatypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('Datatypes\RadioButtonList\Editor', $this->object->getEditor($this->property));
    }
    ...
    {
        $this->assertInstanceOf('Datatypes\RadioButtonList\PrevalueEditor', $this->object->getPrevalueEditor());
    }
}
