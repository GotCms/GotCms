...
class DatatypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('Datatypes\RadioButtonList\Editor', $this->_object->getEditor($this->_property));
    }
    ...
    {
        $this->assertInstanceOf('Datatypes\RadioButtonList\PrevalueEditor', $this->_object->getPrevalueEditor());
    }
}
