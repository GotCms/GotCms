...
class DatatypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @covers Datatypes\Textarea\Datatype::getEditor
     */
    public function testGetEditor()
    {
        $this->assertInstanceOf('Datatypes\Textarea\Editor', $this->_object->getEditor($this->_property));
    }

    /**
     * @covers Datatypes\Textarea\Datatype::getPrevalueEditor
     */
    public function testGetPrevalueEditor()
    {
        $this->assertInstanceOf('Datatypes\Textarea\PrevalueEditor', $this->_object->getPrevalueEditor());
    }
}
