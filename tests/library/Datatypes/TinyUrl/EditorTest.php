...
class EditorTest extends TestCase
{
    ...
    protected $serializedString = 'a:2:{i:0;s:18:"http://got-cms.com";i:1;s:26:"http://tinyurl.com/mz3da2o";}';
    /**
     ...
     * @return void
     */
    public function testSaveWithWrongValue()
    {
        $this->object->getRequest()->getPost()->set($this->object->getName(), 'fake');
        $this->object->save();
        $this->assertEquals('a:0:{}', $this->object->getValue());
    }
