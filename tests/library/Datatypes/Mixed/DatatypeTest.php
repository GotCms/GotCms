...
class DatatypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('Datatypes\Mixed\Editor', $this->_object->getEditor($this->_property));
    }
    ...
    {
        $this->assertInstanceOf('Datatypes\Mixed\PrevalueEditor', $this->_object->getPrevalueEditor());
    }
}
