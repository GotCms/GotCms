...
class DatatypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('Datatypes\jQueryFileUpload\Editor', $this->_object->getEditor($this->_property));
    }
    ...
    {
        $this->assertInstanceOf('Datatypes\jQueryFileUpload\PrevalueEditor', $this->_object->getPrevalueEditor());
    }
}
