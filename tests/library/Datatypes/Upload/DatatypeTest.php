...
class DatatypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @covers Datatypes\Upload\Datatype::getEditor
     */
    public function testGetEditor()
    {
        $this->assertInstanceOf('Datatypes\Upload\Editor', $this->_object->getEditor($this->_property));
    }

    /**
     * @covers Datatypes\Upload\Datatype::getPrevalueEditor
     */
    public function testGetPrevalueEditor()
    {
        $this->assertInstanceOf('Datatypes\Upload\PrevalueEditor', $this->_object->getPrevalueEditor());
    }
}
