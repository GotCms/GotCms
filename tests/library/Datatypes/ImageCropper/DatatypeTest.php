...
class DatatypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('Datatypes\ImageCropper\Editor', $this->object->getEditor($this->property));
    }
    ...
    {
        $this->assertInstanceOf('Datatypes\ImageCropper\PrevalueEditor', $this->object->getPrevalueEditor());
    }
}
