...
class DatatypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('Datatypes\CheckboxList\Editor', $this->_object->getEditor($this->_property));
    }
    ...
    {
        $this->assertInstanceOf('Datatypes\CheckboxList\PrevalueEditor', $this->_object->getPrevalueEditor());
    }
}
