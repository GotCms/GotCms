...
* GotCms is a **Content Management System** (CMS) based on [Zend Framework 2.3.0](http://framework.zend.com/) which enables you to build websites and powerful online applications.
...
[https://github.com/GotCms/GotCms/archive/1.2.0.zip](https://github.com/GotCms/GotCms/archive/1.2.0.zip)
