...
Composer:
    ...
    $ php composer.phar create-project gotcms/gotcms path/ 1.4.2
...
[https://github.com/GotCms/GotCms/archive/1.4.2.zip](https://github.com/GotCms/GotCms/archive/1.4.2.zip)
