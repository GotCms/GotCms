...
* GotCms is a **Content Management System** (CMS) based on [Zend Framework 2.2.3](http://framework.zend.com/) which enables you to build websites and powerful online applications.
...
Composer:
    ...
    $ php composer.phar create-project gotcms/gotcms path/ 0.2.0
...
[https://github.com/GotCms/GotCms/archive/0.2.0.zip](https://github.com/GotCms/GotCms/archive/0.2.0.zip)
